...
(function ($)
{
    ...
    LG.loadToolbar = function (grid, toolbarBtnItemClick,ctx,tab1,tab2,tab3,tab4,tab5,url1,url2,url3,url4)
    {  
    	var items = [];
    	items[0]= {
    	...
    	items[2]= {
                ...
                icon: 'modify',
                id:'modify',
                img:ctx+'/javascripts/backcontrol/ligerUI/skins/icons/edit.gif',
                tabName:tab2,
                url:ctx+'/backcontrol/'+url1
        };
    	items[3] = { line: true };
    	items[4]= {
                ...
                icon: 'detail',
                id:'detail',
                img:ctx+'/javascripts/backcontrol/ligerUI/skins/icons/search.gif',
                tabName:tab3,
                url:ctx+'/backcontrol/'+url2
    	...
    	items[8]= {
                ...
                icon: 'save',
                id:'save',
                img:ctx+'/javascripts/backcontrol/ligerUI/skins/icons/save.gif',
                tabName:tab5,
                url:ctx+'/backcontrol/'+url4
    ...
    {    
        ...
        {  
           ...
           // tabid = $(".l-dialog-table").attr("tabid");
        }
        if (tab)
        {
    ...
    //关闭Tab项并且刷新父窗口
    LG.closeAndReloadParent = function (tabid)
    {  
    ...
    //打开窗口
    LG.toAddDialog = function(url,height,width,grids,title){
    	grid = grids;
    	dialog = $.ligerDialog.open({ url: url, height: height, width: width, isResize: true,title:title});
    };
    
    //关闭窗口
    LG.clossDialog = function(){
    	dialog.close();
    	dialog.unmask();
    	grid.loadData();
    };
    ...
    //删除方法
    LG.f_delete=function(selected,url){
         if (selected)
         {
             if (!selected.id)
             {
