    ...
    window.liger = $.ligerui = {
        ...
        {   console.log("run");
            ...
            {    console.log("run-----this--");
                ...
                console.log("run-----return-extends-");
...
(function ($)
{
    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        {    console.log("_render15111");  
            ...
            g.wrapper.append('<div class="l-text-lfff"></div><div class="l-text-r"></div>');
            console.log("0000000");
            g.wrapper.append(g.link);
            //添加个包裹，
            g.textwrapper = g.wrapper.wrap('<div class="l-text-wrapper-add"></div>').parent();
            ...
            g.inputText.addClass("l-text-field-select");
...
(function ($)
{
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        {   console.log("_render23");
            ...
            g.text.append('<div class="l-text-lfff"></div><div class="l-text-r"></div>');
...
(function ($)
{
    ...
    $.ligerDefaults.Form.editorBulider = function (jinput)
    {
        ...
        else if (jinput.is(":text") || jinput.is(":password"))
        {
            ...
            console.log("combobox"+inputOptions);
            switch (ltype)
            {
                case "select":
                case "combobox":
...
(function ($)
{
    ...
    $.ligerui.controls.TextBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {   console.log("_render5");
            var g = this, p = this.options;
            g.inputText = $(this.element);
            //外层
            g.wrapper = g.inputText.wrap('<div class="l-text"></div>').parent();
            g.wrapper.append('<div class="l-textfff-l"></div><div class="l-text-r"></div>');
            if (!g.inputText.hasClass("l-text-field"))
                g.inputText.addClass("l-text-field");
            this._setEvent();
            g.set(p);
...
(function ($)
		{
		    $.fn.ligerTableDetail = function ()
		    {   
		        return $.ligerui.run.call(this, "ligerTableDetail", arguments);
		    };

		    $.ligerDefaults = $.ligerDefaults || {};
		    $.ligerDefaults.TableDetail = {
		        //控件宽度
		        textWidth: 180,
		        //标签宽度
		        labelWidth: 90,
		    ...
		    //@description 默认表单编辑器构造器扩展(如果创建的表单效果不满意 建议重载)
		    //@param {jinput} 表单元素jQuery对象 比如input、select、textarea 
		    $.ligerDefaults.TableDetail.editorBulider = function (jinput)
		    {
		        //这里this就是form的ligerui对象
		        var g = this, p = this.options;
		        var inputOptions = {};
		    ...
		    //表单组件
		    $.ligerui.controls.TableDetail = function (element, options)
		    {
		        $.ligerui.controls.TableDetail.base.constructor.call(this, element, options);
		    };

		    $.ligerui.controls.TableDetail.ligerExtend($.ligerui.core.UIComponent, {
		        __getType: function ()
		        {
		            return 'TableDetail'
		        },
		        ...
		        _init: function ()
		        {
		            $.ligerui.controls.TableDetail.base._init.call(this);
		        },
		        _render: function ()
		        {   console.log("_render151111111");
		            var g = this, p = this.options;
		        ...
		        _buliderControl: function (field)
		        {
		            ...
		            {   console.log("===============================================text_console_log");
		                out.push('<input type="text" dir="yjh" ');
		            }
		            if (field.cssClass)
		            {
		                out.push('class="' + field.cssClass + '" ');
